...
public class OI {
	...
	public OI() {
		...
		operatorButtonB.whenPressed(new Preset_AutoAndFrontPyramid_3pt());
		
		operatorButtonX.whenPressed(new Preset_TopPyramid_5pt());
		operatorButtonA.whenPressed(new Preset_AutoAndFrontPyramid_3pt());
